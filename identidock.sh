# this is a build script for the identidock project
# this is a good start for experimentation, but this does
# not handle the deploy to the CoreOS server. 
# Additional work will be required to add these steps.
